...
enabled; its persistent Compose candidate must set exactly
`SSRF_ALLOWED_HOSTS=inbound-receiver` before the controlled recreation.
...
`http://inbound-receiver:9011/webhook`, and fails closed on a duplicate or
