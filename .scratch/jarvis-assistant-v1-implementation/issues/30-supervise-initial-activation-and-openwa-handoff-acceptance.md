# 30 — Supervise initial activation and OpenWA handoff acceptance

**What to build:** Under direct human supervision, provision the real trust boundaries, deliberately activate the pinned Jarvis release, attach the single private OpenWA handoff network, and prove the established messaging-gateway contract remains intact.
