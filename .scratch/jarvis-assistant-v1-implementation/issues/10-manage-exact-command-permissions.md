...
- [x] Session and persistent permission choices create and execute atomically with the defined lifetimes and provenance.
- [x] Listing is deterministic, revocation removes usable authority before acknowledgement, and higher policy always takes precedence over a match.
