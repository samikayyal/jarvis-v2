# 03 — Enforce append-only audit admission and safe inspection

**What to build:** Security-relevant activity produces bounded, redacted, append-only evidence that can be safely filtered and exported through local administration. Required audit failure blocks every WhatsApp response and side effect.
